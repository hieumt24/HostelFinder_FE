            ...
            <div className="row">
               <div className="col-xl-8 m-auto">
                  <div className="title-one text-center mb-35 lg-mb-20">
                     <h3 style={{ fontFamily: 'Arial, sans-serif'}}>Chúng tôi ở đây để giúp <br /> bạn có được <span>căn phòng mơ ước<Image src={titleShape} alt="" className="lazy-img" /></span></h3>
                     <p className="fs-24 color-dark" style={{ fontFamily: 'Arial, sans-serif'}}>Thật dễ dàng để bắt đầu với chúng tôi bằng những bước đơn giản sau</p>
                  </div>
               </div>
            </div>
