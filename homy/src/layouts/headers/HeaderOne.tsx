        ...
        <span className="logo-text" style={{ fontSize: '25px', color: 'black', marginRight: '10px' }}>PhongTro24/7</span>
                     ...
                     <div className="right-widget ms-auto ms-lg-0 me-3 me-lg-0 order-lg-3">
                        <ul className="d-flex align-items-center style-none">
                           <li>
                              <Link href="#" data-bs-toggle="modal" data-bs-target="#loginModal" className="btn-one"><i className="fa-regular fa-lock"></i> <span style={{ fontFamily: "'Fira Code', sans-serif" }}>Đăng nhập</span></Link>
                           </li>
